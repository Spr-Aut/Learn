...
public class NoscrollListActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        NoScrollListView nslv_planet2 = findViewById(R.id.nslv_planet2);
        nslv_planet2.setAdapter(adapter2); // 设置不滚动列表视图的行星适配器
        nslv_planet2.setOnItemClickListener(adapter2);
        nslv_planet2.setOnItemLongClickListener(adapter2);
    }
}
